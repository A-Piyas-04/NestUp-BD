...
const ListingCard = ({ listing }) => {
  const { id, title, location, rating, price, image } = listing;
  ...
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
      ...
      <div className="relative pb-[56.25%] overflow-hidden"> {/* 16:9 aspect ratio */}
        <img 
          src={image || 'https://placehold.co/400x225?text=No+Image'} 
          alt={title}
      ...
      <div className="p-4">
        ...
        <div className="flex justify-between items-center">
          <div className="text-primary font-semibold">
            ...
            <span className="text-xs text-gray-500 font-normal"> /service</span>
          </div>
